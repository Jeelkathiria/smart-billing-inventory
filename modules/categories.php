...
<body>
        ...
        <div class="table-responsive">
          <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
              ...
              <tr data-bs-toggle="collapse" data-bs-target="#products-<?= $row['category_id'] ?>" aria-expanded="false"
                class="category-row">
  ...
  // Rotate icon when expanding/collapsing
  document.addEventListener('click', function(e) {
    if (e.target.closest('.category-row')) {
      const icon = e.target.closest('.category-row').querySelector('.toggle-icon');
      const collapse = e.target.closest('.category-row').getAttribute('data-bs-target');
